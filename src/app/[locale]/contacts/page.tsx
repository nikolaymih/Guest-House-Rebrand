      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          ...
          <a
            ...
            className="bg-[var(--color-linen)] rounded-2xl p-6 text-center shadow-[var(--shadow-soft)] flex items-center justify-center gap-2 hover:bg-[var(--color-linen)]/70 transition-colors text-[var(--color-caramel)] font-semibold"
          >

...
export default async function ContactsPage({ params }: Props) {
  ...
  const contacts = [
    ...
    { label: t("facebookLabel"), value: "Становец", href: "https://www.facebook.com/people/%D0%A1%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%B5%D1%86/100063453006216/" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {contacts.map((c) => (
            <div key={c.href} className="bg-[var(--color-linen)] rounded-2xl p-6 text-center shadow-[var(--shadow-soft)]">
              ...
              <a href={c.href} className="text-[var(--color-caramel)] font-semibold hover:text-[var(--color-caramel-deep)] transition-colors">
                {c.value}
              </a>
            </div>
          ))}

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-8">
          <a
            ...
            className="inline-flex items-center gap-2 bg-[var(--color-walnut)] hover:bg-[var(--color-walnut)]/80 transition-colors rounded-lg px-4 py-2 text-sm font-semibold text-[var(--color-warm-white)] w-full sm:w-auto"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              className="w-5 h-5 text-[var(--color-candlelight)] flex-shrink-0" aria-hidden="true">
